...
const uint8_t rawDataStream[] =
{
    ...
    0xa7, 0x4f, // ID
    0x60, 0x00, // Length
    0x80, 0x43, 0x6c, 0x1b, 0x63, 0x09, 0x03, 0x00,
...
uint8_t buffer1[3084];

// Account for the largest SPARTN messages
uint8_t buffer2[3095];
...
void parserTests()
{
    ...
    sempDebugOutputEnable(parse1, output); // Debug - comment if desired
    ...
    sempDebugOutputEnable(parse2, output); // Debug - comment if desired
