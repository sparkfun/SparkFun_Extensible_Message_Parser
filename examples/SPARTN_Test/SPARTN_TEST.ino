...
#define RAW_DATA_BYTES      (sizeof(gUSpartnTestData) / sizeof(gUSpartnTestData[0]))
...
void setup()
{
    ...
    for (dataOffset = 0; dataOffset < RAW_DATA_BYTES; dataOffset++)
        ...
        sempParseNextByte(parse, gUSpartnTestData[dataOffset]);
...
void processMessage(SEMP_PARSE_STATE *parse, uint16_t type)
{
    ...
    Serial.printf("Valid SPARTN message: %d bytes at 0x%08x (%d)\r\n",
